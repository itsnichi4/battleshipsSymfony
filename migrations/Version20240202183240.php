 ...
 */
final class Version20240202183240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP player2_id, CHANGE player1_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD player2_id INT DEFAULT NULL, CHANGE user_id player1_id INT NOT NULL');
